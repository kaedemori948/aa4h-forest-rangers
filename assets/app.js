...
<div class="card-slider" data-slider>
  ...
  const I18N = {
    ja: {
      ...
      fb_title:"アセット要望フォーム",
      fb_intro:"探していたアセットが見つからなかった場合や、サイトの使い勝手について意見がある場合、このフォームで状況を教えてください。入力内容を整理して GitHub Issue として送信できる形式に自動変換します。",
      fb_required_note:"は必須項目です",
      fb_type_title:"フィードバックの種類", fb_type_desc:"当てはまるものを選んでください",
      fb_type_label:"種類",
      fb_type_specific:"目的のアセットがあったが見つからなかった", fb_type_browse:"なんとなく探したが見つからなかった", fb_type_ux:"サイトの使い勝手について意見がある",
      ...
      fb_confidence_label:"同種のアセットが社内に存在する可能性についての感触（任意）",
      fb_confidence_ph:"選択してください", fb_conf_similar:"似たものはあったが機能・データが足りなかった", fb_conf_unsure:"社内に同種のものがあるかは分からない", fb_conf_sure:"探した範囲では存在しないと思う",
      ...
      fb_s5_title:"困りごとの詳細", fb_s5_desc:"サイトのどこで何に困ったか教えてください",
      fb_page_label:"該当ページ",
      fb_page_ph:"選択してください", fb_page_home:"ホーム", fb_page_list:"アセット一覧", fb_page_detail:"アセット詳細", fb_page_feedback:"要望フォーム", fb_page_other:"その他",
      fb_ux_desc_label:"具体的な困りごと", fb_ux_desc_ph:"例：一覧画面でソートを変更すると、選択していたフィルタが解除されてしまう。",
      fb_severity_label:"深刻度",
      fb_severity_ph:"選択してください", fb_sev_minor:"軽微（少し不便）", fb_sev_annoying:"困る（作業が止まる）", fb_sev_blocker:"致命的（使えない）",
      fb_steps_label:"再現手順（任意）", fb_steps_ph:"例：1. 一覧画面を開く 2. カテゴリを『営業』に絞り込む 3. 並び順を『DL数順』に変更する",
      ...
      fb_title_prefix_ux:"[UX改善] ", fb_title_untitled_ux:"[UX改善] （タイトル未入力）",
      fb_md_overview:"## 📌 概要", fb_md_search:"## 🔍 検索状況", fb_md_feedback_type:"**フィードバック種別:**", fb_md_tried:"**試した操作:**", fb_md_keywords:"**使用キーワード:**", fb_md_result:"**結果の状況:**", fb_md_confidence:"**存在有無の感触:**", fb_md_want:"## 💡 求めているアセット", fb_md_tentative:"**仮称:**", fb_md_features:"**求める機能・処理:**", fb_md_tools:"**連携ツール:**", fb_md_ref:"**参考:**", fb_md_page:"**該当ページ:**", fb_md_severity:"**深刻度:**", fb_md_steps:"**再現手順:**", fb_md_unfilled:"（未入力）", fb_md_none:"（未選択）", fb_md_labels_head:"## 🏷️ Labels",
      fb_val_intro:"以下の必須項目を入力してください:", fb_val_type:"フィードバックの種類（セクション1）", fb_val_goal:"達成したかったこと（セクション2）", fb_val_result:"検索結果の状況（セクション3）", fb_val_desc:"求める機能・処理（セクション4）", fb_val_ux_desc:"具体的な困りごと（セクション5）", fb_send_fail:"送信に失敗しました: ",
    },
    en: {
      ...
      fb_intro:"If you couldn't find the asset you were looking for, or you have feedback about the site's usability, tell us about it here. Your input is automatically formatted so it can be submitted as a GitHub Issue.",
      fb_required_note:"fields are required",
      fb_type_title:"Type of Feedback", fb_type_desc:"Choose the one that fits best",
      fb_type_label:"Type",
      fb_type_specific:"I had a specific asset in mind but couldn't find it", fb_type_browse:"I browsed around but couldn't find anything", fb_type_ux:"I have feedback about the site's usability",
      ...
      fb_confidence_label:"How confident are you that a similar asset exists internally? (optional)",
      fb_confidence_ph:"Select…", fb_conf_similar:"Something similar existed but lacked features/data", fb_conf_unsure:"Not sure if anything similar exists internally", fb_conf_sure:"I'm fairly sure nothing like it exists",
      ...
      fb_s5_title:"Issue Details", fb_s5_desc:"Tell us where and what went wrong",
      fb_page_label:"Relevant page",
      fb_page_ph:"Select…", fb_page_home:"Home", fb_page_list:"Asset list", fb_page_detail:"Asset detail", fb_page_feedback:"Feedback form", fb_page_other:"Other",
      fb_ux_desc_label:"What went wrong", fb_ux_desc_ph:"e.g. Changing the sort order on the list page resets the filters I had selected.",
      fb_severity_label:"Severity",
      fb_severity_ph:"Select…", fb_sev_minor:"Minor (a bit inconvenient)", fb_sev_annoying:"Annoying (blocks my work)", fb_sev_blocker:"Critical (unusable)",
      fb_steps_label:"Steps to reproduce (optional)", fb_steps_ph:"e.g. 1. Open the list page 2. Filter by category 'Sales' 3. Change sort order to 'Most downloaded'",
      ...
      fb_title_prefix_ux:"[UX Improvement] ", fb_title_untitled_ux:"[UX Improvement] (untitled)",
      fb_md_overview:"## 📌 Overview", fb_md_search:"## 🔍 Search Situation", fb_md_feedback_type:"**Feedback type:**", fb_md_tried:"**Methods tried:**", fb_md_keywords:"**Keywords used:**", fb_md_result:"**Result situation:**", fb_md_confidence:"**Confidence it exists:**", fb_md_want:"## 💡 Requested Asset", fb_md_tentative:"**Tentative name:**", fb_md_features:"**Desired features / behavior:**", fb_md_tools:"**Integrations:**", fb_md_ref:"**References:**", fb_md_page:"**Relevant page:**", fb_md_severity:"**Severity:**", fb_md_steps:"**Steps to reproduce:**", fb_md_unfilled:"(not filled in)", fb_md_none:"(none selected)", fb_md_labels_head:"## 🏷️ Labels",
      fb_val_intro:"Please fill in the following required fields:", fb_val_type:"Type of feedback (Section 1)", fb_val_goal:"What you wanted to achieve (Section 2)", fb_val_result:"Search result situation (Section 3)", fb_val_desc:"Desired features / behavior (Section 4)", fb_val_ux_desc:"What went wrong (Section 5)", fb_send_fail:"Failed to send: ",
    },
  };
